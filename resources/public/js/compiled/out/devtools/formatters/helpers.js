...
var G__41454 = devtools.prefs.pref.call(null,v);
v = G__41454;
continue;
} else {
return v;
...
}catch (e41467){var e__39131__auto__ = e41467;
return false;
}})();
...
}catch (e41471){var e__39131__auto__ = e41471;
return false;
}})();
...
}catch (e41473){var e__39131__auto__ = e41473;
return false;
}}
}
});
...
var vec__41478 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__41478,(0),null);
var name = cljs.core.nth.call(null,vec__41478,(1),null);
...
return cljs.core.some.call(null,(function (p1__41481_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41481_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1479706428265