...
var len__28475__auto___41495 = arguments.length;
var i__28476__auto___41496 = (0);
while(true){
if((i__28476__auto___41496 < len__28475__auto___41495)){
args__28482__auto__.push((arguments[i__28476__auto___41496]));

var G__41497 = (i__28476__auto___41496 + (1));
i__28476__auto___41496 = G__41497;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28483__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41492){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__41493,G__41494,seq41492__$2);
});
...
if(cljs.core.truth_((function (){var or__27400__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__28006__auto__,writer__28007__auto__,opt__28008__auto__){
return cljs.core._write.call(null,writer__28007__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27388__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27388__auto__){
var or__27400__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27400__auto__)){
return or__27400__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41498_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__41498_SHARP_));
})))){
...
var map__41507 = opts;
var map__41507__$1 = ((((!((map__41507 == null)))?((((map__41507.cljs$lang$protocol_mask$partition0$ & (64))) || (map__41507.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41507):map__41507);
var markup_db = cljs.core.get.call(null,map__41507__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__27400__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e41511){var e__39131__auto__ = e41511;
return false;
}})();
if(cljs.core.truth_(or__27400__auto__)){
return or__27400__auto__;
...
}catch (e41513){var e__39131__auto__ = e41513;
return false;
}}
})())){
...
var _STAR_current_state_STAR_41518 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__41519 = opts;
...
var markup_db = cljs.core.get.call(null,map__41519__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_41518;
}});
...
;
var temp__4655__auto___41524 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___41524)){
var managed_print_level_41525 = temp__4655__auto___41524;
var _STAR_print_level_STAR_41523_41526 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_41525;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_41523_41526,managed_print_level_41525,temp__4655__auto___41524,writer,opts,job_fn){
return (function (p1__41521_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__41521_SHARP_,null);
});})(_STAR_print_level_STAR_41523_41526,managed_print_level_41525,temp__4655__auto___41524,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_41523_41526;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1479706428395