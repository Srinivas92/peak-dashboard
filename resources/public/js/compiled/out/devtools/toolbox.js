...
var args41965 = [];
var len__28475__auto___41971 = arguments.length;
var i__28476__auto___41972 = (0);
while(true){
if((i__28476__auto___41972 < len__28475__auto___41971)){
args41965.push((arguments[i__28476__auto___41972]));

var G__41973 = (i__28476__auto___41972 + (1));
i__28476__auto___41972 = G__41973;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox41968 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox41968 = (function (obj,header,style,tag,meta41969){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox41968.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41970,meta41969__$1){
var self__ = this;
var _41970__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox41968(self__.obj,self__.header,self__.style,self__.tag,meta41969__$1));
});

devtools.toolbox.t_devtools$toolbox41968.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41970){
var self__ = this;
var _41970__$1 = this;
return self__.meta41969;
});

devtools.toolbox.t_devtools$toolbox41968.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox41968.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox41968.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox41968.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox41968.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta41969","meta41969",279099595,null)], null);
});

devtools.toolbox.t_devtools$toolbox41968.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox41968.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox41968";

devtools.toolbox.t_devtools$toolbox41968.cljs$lang$ctorPrWriter = (function (this__28006__auto__,writer__28007__auto__,opt__28008__auto__){
return cljs.core._write.call(null,writer__28007__auto__,"devtools.toolbox/t_devtools$toolbox41968");
});

devtools.toolbox.__GT_t_devtools$toolbox41968 = (function devtools$toolbox$__GT_t_devtools$toolbox41968(obj__$1,header__$1,style__$1,tag__$1,meta41969){
return (new devtools.toolbox.t_devtools$toolbox41968(obj__$1,header__$1,style__$1,tag__$1,meta41969));
});

}

return (new devtools.toolbox.t_devtools$toolbox41968(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1479706429175