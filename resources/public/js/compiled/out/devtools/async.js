...
var o__39106__auto___42226 = (function (){var o__39106__auto__ = (function (){var o__39106__auto__ = Promise;
return goog.object.get(o__39106__auto__,"resolve").call(o__39106__auto__);
})();
return goog.object.get(o__39106__auto__,"then").call(o__39106__auto__,callback);
})();
goog.object.get(o__39106__auto___42226,"catch").call(o__39106__auto___42226,devtools.async.rethrow_outside_promise);
...
var G__42228_42229 = Error;
var target__39125__auto___42230 = G__42228_42229;
if(cljs.core.truth_(target__39125__auto___42230)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__42228_42229)].join('')),cljs.core.str("\n"),cljs.core.str("target__39125__auto__")].join('')));
}

goog.object.set(target__39125__auto___42230,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1479706429847