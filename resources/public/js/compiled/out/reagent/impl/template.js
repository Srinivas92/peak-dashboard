...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28006__auto__,writer__28007__auto__,opt__28008__auto__){
return cljs.core._write.call(null,writer__28007__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__30448 = o;
(G__30448[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__30450__i < G__30450__a.length) {G__30450__a[G__30450__i] = arguments[G__30450__i + 0]; ++G__30450__i;}
  args = new cljs.core.IndexedSeq(G__30450__a,0);
} 
...
if(cljs.core.truth_((function (){var and__27388__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__27388__auto__){
var and__27388__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__30457 = jsprops;
(G__30457["defaultValue"] = value);

(G__30457["onChange"] = ((function (G__30457,v,value,on_change){
return (function (p1__30454_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30454_SHARP_);
});})(G__30457,v,value,on_change))
);

(G__30457["ref"] = ((function (G__30457,v,value,on_change){
return (function (p1__30455_SHARP_){
return (this$["cljsInputElement"] = p1__30455_SHARP_);
});})(G__30457,v,value,on_change))
);
...
var vec__30464 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30464,(0),null);
var id = cljs.core.nth.call(null,vec__30464,(1),null);
var class$ = cljs.core.nth.call(null,vec__30464,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30469 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30469 == null)){
} else {
var key_30470 = temp__4661__auto___30469;
(jsprops["key"] = key_30470);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30472 = (new reagent.impl.template.NativeWrapper());
(G__30472["name"] = c);
...
var len__28475__auto___30478 = arguments.length;
var i__28476__auto___30479 = (0);
while(true){
if((i__28476__auto___30479 < len__28475__auto___30478)){
args__28482__auto__.push((arguments[i__28476__auto___30479]));

var G__30480 = (i__28476__auto___30479 + (1));
i__28476__auto___30479 = G__30480;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28483__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30476){
var G__30477 = cljs.core.first.call(null,seq30476);
var seq30476__$1 = cljs.core.next.call(null,seq30476);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30477,seq30476__$1);
});
...
break;
default:
var G__30484 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30484;
continue;
...
var n__28315__auto___30487 = a.length;
var i_30488 = (0);
while(true){
if((i_30488 < n__28315__auto___30487)){
(a[i_30488] = reagent.impl.template.as_element.call(null,(a[i_30488])));
...
var a = cljs.core.into_array.call(null,s);
var n__28315__auto___30490 = a.length;
var i_30491 = (0);
while(true){
if((i_30491 < n__28315__auto___30490)){
var val_30492 = (a[i_30491]);
if((cljs.core.vector_QMARK_.call(null,val_30492)) && ((reagent.impl.template.key_from_vec.call(null,val_30492) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30491] = reagent.impl.template.as_element.call(null,val_30492));

var G__30493 = (i_30491 + (1));
i_30491 = G__30493;
continue;
} else {
}
...
var ctx = ({});
var vec__30497 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30497,(0),null);
var derefed = cljs.core.nth.call(null,vec__30497,(1),null);
...
var G__30501 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30501) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30501){
...
//# sourceMappingURL=template.js.map?rel=1479706411586