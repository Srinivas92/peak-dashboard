...
var vec__31053_31056 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_31057 = cljs.core.nth.call(null,vec__31053_31056,(0),null);
var only_after_31058 = cljs.core.nth.call(null,vec__31053_31056,(1),null);
var db_changed_QMARK__31059 = (cljs.core.some_QMARK_.call(null,only_before_31057)) || (cljs.core.some_QMARK_.call(null,only_after_31058));
if(db_changed_QMARK__31059){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_31057);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_31058);
...
var map__31066 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__31066__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__31066__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__31074 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__31074__$1;
var event = cljs.core.get.call(null,map__31074__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__28475__auto___31077 = arguments.length;
var i__28476__auto___31078 = (0);
while(true){
if((i__28476__auto___31078 < len__28475__auto___31077)){
args__28482__auto__.push((arguments[i__28476__auto___31078]));

var G__31079 = (i__28476__auto___31078 + (1));
i__28476__auto___31078 = G__31079;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__28483__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq31076){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31076));
});
...
var args__28482__auto__ = [];
var len__28475__auto___31085 = arguments.length;
var i__28476__auto___31086 = (0);
while(true){
if((i__28476__auto___31086 < len__28475__auto___31085)){
args__28482__auto__.push((arguments[i__28476__auto___31086]));

var G__31087 = (i__28476__auto___31086 + (1));
i__28476__auto___31086 = G__31087;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28483__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__31080_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__31081_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__31081_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq31082){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__31083,G__31084,seq31082__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1479706413596