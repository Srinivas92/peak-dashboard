...
re_frame.subs.query__GT_reaction = (function (){var G__13205 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__13205) : cljs.core.atom.call(null,G__13205));
})();
/**
...
var G__13208 = re_frame.subs.query__GT_reaction;
var G__13209 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__13208,G__13209) : cljs.core.reset_BANG_.call(null,G__13208,G__13209));
});
/**
...
var args13210 = [];
var len__7484__auto___13213 = arguments.length;
var i__7485__auto___13214 = (0);
while(true){
if((i__7485__auto___13214 < len__7484__auto___13213)){
args13210.push((arguments[i__7485__auto___13214]));

var G__13215 = (i__7485__auto___13214 + (1));
i__7485__auto___13214 = G__13215;
continue;
} else {
}
break;
...
var args13217 = [];
var len__7484__auto___13224 = arguments.length;
var i__7485__auto___13225 = (0);
while(true){
if((i__7485__auto___13225 < len__7484__auto___13224)){
args13217.push((arguments[i__7485__auto___13225]));

var G__13226 = (i__7485__auto___13225 + (1));
i__7485__auto___13225 = G__13226;
continue;
} else {
}
break;
...
var temp__4657__auto___13228 = cljs.core.not_empty(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(re_frame.interop.ratom_QMARK_,dynv));
if(cljs.core.truth_(temp__4657__auto___13228)){
var not_reactive_13229 = temp__4657__auto___13228;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$warn,cljs.core.array_seq(["re-frame: your subscription's dynamic parameters that don't implement IReactiveAtom: ",not_reactive_13229], 0));
} else {
}
} else {
}
...
return (function (){
var G__13220 = re_frame.db.app_db;
var G__13221 = v;
var G__13222 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(dyn_vals) : cljs.core.deref.call(null,dyn_vals));
return (handler_fn.cljs$core$IFn$_invoke$arity$3 ? handler_fn.cljs$core$IFn$_invoke$arity$3(G__13220,G__13221,G__13222) : handler_fn.call(null,G__13220,G__13221,G__13222));
...
return (function (){
var G__13223 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(sub) : cljs.core.deref.call(null,sub));
return (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(G__13223) : cljs.core.deref.call(null,G__13223));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__7189__auto__ = (function re_frame$subs$map_vals_$_iter__13248(s__13249){
...
var c__7187__auto__ = cljs.core.chunk_first(s__13249__$2);
var size__7188__auto__ = cljs.core.count(c__7187__auto__);
var b__13251 = cljs.core.chunk_buffer(size__7188__auto__);
if((function (){var i__13250 = (0);
while(true){
if((i__13250 < size__7188__auto__)){
var vec__13260 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7187__auto__,i__13250);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13260,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13260,(1),null);
cljs.core.chunk_append(b__13251,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(val) : f.call(null,val))], null));

var G__13266 = (i__13250 + (1));
i__13250 = G__13266;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13251),re_frame$subs$map_vals_$_iter__13248(cljs.core.chunk_rest(s__13249__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13251),null);
}
} else {
var vec__13263 = cljs.core.first(s__13249__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13263,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13263,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(val) : f.call(null,val))], null),re_frame$subs$map_vals_$_iter__13248(cljs.core.rest(s__13249__$2)));
}
} else {
return null;
}
...
var len__7484__auto___13280 = arguments.length;
var i__7485__auto___13281 = (0);
while(true){
if((i__7485__auto___13281 < len__7484__auto___13280)){
args__7491__auto__.push((arguments[i__7485__auto___13281]));

var G__13282 = (i__7485__auto___13281 + (1));
i__7485__auto___13281 = G__13282;
continue;
} else {
}
break;
...
var inputs_fn = (function (){var G__13269 = cljs.core.count(input_args);
switch (G__13269) {
case (0):
return ((function (G__13269,computation_fn,input_args,err_header){
return (function() {
var G__13284 = null;
var G__13284__1 = (function (_){
return re_frame.db.app_db;
});
var G__13284__2 = (function (_,___$1){
return re_frame.db.app_db;
});
G__13284 = function(_,___$1){
switch(arguments.length){
case 1:
return G__13284__1.call(this,_);
case 2:
return G__13284__2.call(this,_,___$1);
}
...
;})(G__13269,computation_fn,input_args,err_header))
...
return ((function (ret_val,G__13269,computation_fn,input_args,err_header){
return (function() {
...
;})(ret_val,G__13269,computation_fn,input_args,err_header))
...
return ((function (pairs,vecs,ret_val,G__13269,computation_fn,input_args,err_header){
return (function() {
var re_frame$subs$inp_fn = null;
var re_frame$subs$inp_fn__1 = (function (_){
return ret_val;
...
;})(pairs,vecs,ret_val,G__13269,computation_fn,input_args,err_header))
...
return (function (){
var G__13275 = re_frame.subs.deref_input_signals(subscriptions,query_id);
var G__13276 = query_vec;
return (computation_fn.cljs$core$IFn$_invoke$arity$2 ? computation_fn.cljs$core$IFn$_invoke$arity$2(G__13275,G__13276) : computation_fn.call(null,G__13275,G__13276));
...
return re_frame.interop.make_reaction(((function (subscriptions,computation_fn,input_args,err_header,inputs_fn){
return (function (){
var G__13277 = re_frame.subs.deref_input_signals(subscriptions,query_id);
var G__13278 = query_vec;
var G__13279 = dyn_vec;
return (computation_fn.cljs$core$IFn$_invoke$arity$3 ? computation_fn.cljs$core$IFn$_invoke$arity$3(G__13277,G__13278,G__13279) : computation_fn.call(null,G__13277,G__13278,G__13279));
});})(subscriptions,computation_fn,input_args,err_header,inputs_fn))
);
});
...
re_frame.subs.reg_sub.cljs$lang$applyTo = (function (seq13267){
var G__13268 = cljs.core.first(seq13267);
var seq13267__$1 = cljs.core.next(seq13267);
return re_frame.subs.reg_sub.cljs$core$IFn$_invoke$arity$variadic(G__13268,seq13267__$1);
});
