...
var vec__13168_13171 = clojure.data.diff(orig_db,new_db);
var only_before_13172 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13168_13171,(0),null);
var only_after_13173 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13168_13171,(1),null);
var db_changed_QMARK__13174 = (cljs.core.some_QMARK_(only_before_13172)) || (cljs.core.some_QMARK_(only_after_13173));
if(db_changed_QMARK__13174){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only before: ",only_before_13172], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only after : ",only_after_13173], 0));
...
var map__13181 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13181__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13181__$1,cljs.core.cst$kw$event);
...
var map__13189 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
var map__13189__$1 = ((((!((map__13189 == null)))?((((map__13189.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13189.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13189):map__13189);
var coeffects = map__13189__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13189__$1,cljs.core.cst$kw$event);
...
args__7491__auto__.push((arguments[i__7485__auto___13193]));
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq13191){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13191));
});
...
var args__7491__auto__ = [];
var len__7484__auto___13200 = arguments.length;
var i__7485__auto___13201 = (0);
while(true){
if((i__7485__auto___13201 < len__7484__auto___13200)){
args__7491__auto__.push((arguments[i__7485__auto___13201]));

var G__13202 = (i__7485__auto___13201 + (1));
i__7485__auto___13201 = G__13202;
continue;
} else {
}
break;
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__13195_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__13196_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__13196_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq13197){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__13198,G__13199,seq13197__$2);
});
